# FindFFT.cmake
#
# Finds an implementation of the FFTW interface. It will look for
# Intel MKL and, if that is not available,  fall back to FFTW3.
#
...
if(MKL_FOUND)
  ...
  target_compile_features(fft::fft INTERFACE $<TARGET_PROPERTY:MKL::MKL,INTERFACE_COMPILE_OPTIONS>)
  target_include_directories(fft::fft INTERFACE $<TARGET_PROPERTY:MKL::MKL,INTERFACE_INCLUDE_DIRECTORIES>)
  target_link_libraries(fft::fft INTERFACE $<LINK_ONLY:MKL::MKL_DPCPP>)
