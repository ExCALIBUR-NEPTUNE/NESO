...
PYBIND11_MODULE(PyNESO, m) {
  ...
  m.def("sobol_within_extents", &NESO::sobol_within_extents);  // TODO: Provide proper wrappers for extents array
  ...
  m.def("rsequence_within_extents", &NESO::rsequence_within_extents, py::arg("N"), py::arg("ndim"), py::arg("extents"), py::arg("seed")=0); // TODO: Provide proper wrappers for extents array
}
