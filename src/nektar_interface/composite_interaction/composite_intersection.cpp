...
template <typename T>
void CompositeIntersection::find_intersections(
...
template void CompositeIntersection::find_intersections<ParticleGroup>(
...
template void CompositeIntersection::find_intersections<ParticleSubGroup>(
