...
class ProjectPyramidCell : public ::testing::TestWithParam<TestData> {
public:
  double Integrate(TestData &test_data) {
    return UnitTest::integrate_impl<Project::ePyramid, Project::ThreadPerCell>(
        test_data);
  }
};
...
public:
  double Integrate(TestData &test_data) {
    return UnitTest::integrate_impl<Project::ePyramid, Project::ThreadPerDof>(
        test_data);
  }
};
