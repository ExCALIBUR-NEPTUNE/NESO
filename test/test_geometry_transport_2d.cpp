...
TEST(GeometryTransport2DTest, QuadClone) {
    ...
    for (int yx=0 ; yx<2 ; yx++){
        PointGeomSharedPtr p0 = std::make_shared<PointGeom>(2, 0, (rank * E) + 0.0    , (yx + 0.0) * E, 0.0);
        PointGeomSharedPtr p1 = std::make_shared<PointGeom>(2, 1, (rank * E) + 1.0 * E, (yx + 0.0) * E, 0.0);
        PointGeomSharedPtr p2 = std::make_shared<PointGeom>(2, 2, (rank * E) + 1.0 * E, (yx + 1.0) * E, 0.0);
        PointGeomSharedPtr p3 = std::make_shared<PointGeom>(2, 3, (rank * E) + 0.0    , (yx + 1.0) * E, 0.0);
        edge_points[0] = p0;
        edge_points[1] = p1;
    ...
    {   
        ...
        cout << "Num verts: " << num_verts << " remote rank " << rg->rank << " remote id " << rg->id << endl;
        ...
        std::cout << "contains point? " << rg->geom->ContainsPoint(point) << std::endl;
